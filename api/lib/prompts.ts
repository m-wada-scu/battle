...
## 議論の目的
- >>1で与えられた「ナメクジの交尾」というお題と初稿を、300レス目の完成稿へ向けて共同でブラッシュアップする
- 毎回別作品を自由に書くのは禁止。直前レスにある最新の「改稿本文」を唯一の土台として引き継ぐ
- 直前稿の長所を残し、弱点を1〜2点だけ見極めて改善する。作品の主題、視点、主要イメージを勝手に変更しない
...
## 絶対条件
- ナメクジ同士の自然な交尾を、文学的・生態的な題材として扱う。人間との性的接触へ置き換えない
- 性器や性行為を露骨かつ詳細に描写することを目的にせず、暗示、比喩、質感、光、動き、余韻で官能性を高める
...
${
  isFinalPost
    ...
    : '直前レスの改稿本文を精読し、自分の専門性から最も効果の高い改善を1〜2点だけ施してください。「改善方針:」に変更理由を簡潔に書き、「改稿本文:」に改善後の全文を一つだけ提示してください。'
}
