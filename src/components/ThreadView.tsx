    ...
    <div className="thread">
      <header className="thread-header">
        ...
        <p className="thread-meta">
          1-{posts.length} | 次の書き込み: <strong>{nextLabel}</strong>（{rotation} の順 / 3分間隔）
        </p>
      </header>

      <div className="thread-toolbar">
        <span className="toolbar-item">☺ 酒を片手に見守る</span>
        <span className="toolbar-item">更新: Realtime</span>
        {import.meta.env.DEV && (
          <button
            type="button"
      ...
      <footer className="thread-footer">
        ...
        <p className="footer-note">Powered by GPT / Gemini + Supabase + Vercel Cron</p>
      </footer>
    </div>
  )
}
